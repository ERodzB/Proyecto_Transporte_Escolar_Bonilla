...
INSERT [dbo].[Contratos] ([Codigo_Contrato], [Cliente_Contrato], [Tipo_Contrato], [Monto Mensual], [Meses Pagados], [Servicio], [Anticipo], [Fecha_Inicio_Contrato], [Monto_Contrato], [Fecha_Vencimiento], [Estado_Contrato], [Cod_Documento]) VALUES (N'2019-1-E', N'0801199802725', 1, 1200.0000, 5, N'Bus Completo', 0.0000, CAST(N'2019-01-01' AS Date), 6000.0000, CAST(N'2019-06-01' AS Date), 1, N'CTr')
INSERT [dbo].[Contratos] ([Codigo_Contrato], [Cliente_Contrato], [Tipo_Contrato], [Monto Mensual], [Meses Pagados], [Servicio], [Anticipo], [Fecha_Inicio_Contrato], [Monto_Contrato], [Fecha_Vencimiento], [Estado_Contrato], [Cod_Documento]) VALUES (N'2019-2-B', N'0801199000001', 2, 0.0000, 0, N'Ida y Vuelta', 2500.0000, CAST(N'2019-06-06' AS Date), 4500.0000, CAST(N'2019-06-07' AS Date), 2, N'CTr')
...
INSERT [dbo].[Empleado] ([Identidad_Empleado], [Nombre_Empleado], [Fecha_Nacimiento], [Genero], [Telefono], [Correo], [Direccion], [Puesto_Empleado], [Salario]) VALUES (N'0801199919518
', N'Anthony Wylberth Rodríguez Thompson', CAST(N'1999-09-07' AS Date), N'Masculino', N'87345567', N'awrodriguezt@gmail.com', N'Residencial Plaza, Bloque 70, Casa #2350', 1, 14000.0000)
...
INSERT [dbo].[Recibos] ([Num_Recibo], [Codigo_Contrato], [Codigo_Documento], [Fecha_Recibo], [Monto], [Numero_CAI], [Descripcion de Recibo]) VALUES (1, N'2019-1-E', N'RCTr', CAST(N'2019-01-01' AS Date), 6000.0000, N'1', N'Pago de Mensualidad por 6 meses')
INSERT [dbo].[Recibos] ([Num_Recibo], [Codigo_Contrato], [Codigo_Documento], [Fecha_Recibo], [Monto], [Numero_CAI], [Descripcion de Recibo]) VALUES (2, N'2019-2-B', N'RCTr', CAST(N'2019-06-06' AS Date), 2500.0000, N'1', N'Anticipo de viaje privado')
INSERT [dbo].[Recibos] ([Num_Recibo], [Codigo_Contrato], [Codigo_Documento], [Fecha_Recibo], [Monto], [Numero_CAI], [Descripcion de Recibo]) VALUES (3, N'2019-2-B', N'RCTr', CAST(N'2019-06-07' AS Date), 2000.0000, N'1', N'Pago Restante de Viaje')
...
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'Aleman - El Centro', N'PAF5039', CAST(N'04:30:00' AS Time), CAST(N'06:00:00' AS Time), 0)
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'Aleman - El Centro', N'PAT5457', CAST(N'06:00:00' AS Time), CAST(N'07:30:00' AS Time), 0)
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'Aleman - El Centro', N'PAF5039', CAST(N'07:30:00' AS Time), CAST(N'09:00:00' AS Time), 0)
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'	San Francisco - El Centro', N'PAW4234', CAST(N'06:00:00' AS Time), CAST(N'09:00:00' AS Time), 0)
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'	San Francisco - El Centro', N'PAF5039', CAST(N'09:30:00' AS Time), CAST(N'12:00:00' AS Time), 0)
INSERT [dbo].[Vehiculos_Rutas] ([Codigo_Ruta], [Codigo_Vehiculo], [Horario_Salida], [Horario_Entrada], [Cantidad_Alumnos_Actuales]) VALUES (N'Viaje-1', N'PAT5457', CAST(N'06:00:00' AS Time), CAST(N'12:00:00' AS Time), NULL)
Go