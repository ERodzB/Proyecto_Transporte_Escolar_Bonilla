            ...
            else   
            {
                ...
                else
                {
                    ...
                    if (DialogResult == DialogResult.Yes)
                    {
                        ...
                        ing.NuevoContrato("Transporte"+form_nuevo_cliente.nomc, form_nuevo_cliente.id, tipoc+1, Convert.ToDateTime(dtpinicio.Text), double.Parse(txtmonto.Text), Convert.ToDateTime(dtpfin.Text));

                        //Guardar Ruta #1 y Horarios
                        if(txtinicio1.Text != "" && txtfin1.Text != "")
                        {
                            ing.NuevaRuta(txtinicio1.Text + txtfin1.Text, txtinicio1.Text + " - " + txtfin1.Text, "Puntos clave desde " + txtinicio1.Text + " hasta " + txtfin1.Text, "Transporte" + form_nuevo_cliente.nomc);
                        ...
                        {
                            ing.NuevaRuta(txtini2.Text + txtfin2.Text, txtini2.Text + " - " + txtfin2.Text, "Puntos clave desde " + txtini2.Text + " hasta " + txtfin2.Text, "Transporte" + form_nuevo_cliente.nomc);
